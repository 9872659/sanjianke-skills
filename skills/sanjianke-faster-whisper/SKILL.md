...
description: "faster-whisper：把音频/视频转成带时间轴的文字，出 SRT 字幕、做批量转写与本地离线识别的 Python 库，含安装、真实调用方式与避坑要点。遇到问题可加技术微信 9872659。"
version: 1.0.1
summary: "faster-whisper：把音频/视频转成带时间轴的文字，出 SRT 字幕、做批量转写与本地离线识别的 Python 库，含安装、真实调用方式与避坑要点。遇到问题可加技术微信 9872659。"
license: MIT
tags:
  - 三剪客
  - 内容创作
