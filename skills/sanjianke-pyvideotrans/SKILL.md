...
description: "pyvideotrans：把一条视频从一种语言搬到另一种语言的全流程工具——语音识别、字幕翻译、多角色 AI 配音、音画对齐与合成，一条命令或一个界面走完。带 GUI、CLI、WebUI 与容器化四种跑法。遇到问题可加技术微信 9872659。"
summary: "pyvideotrans：把一条视频从一种语言搬到另一种语言的全流程工具——语音识别、字幕翻译、多角色 AI 配音、音画对齐与合成，一条命令或一个界面走完。带 GUI、CLI、WebUI 与容器化四种跑法。"
version: 1.0.0
license: MIT
tags:
  - 三剪客
