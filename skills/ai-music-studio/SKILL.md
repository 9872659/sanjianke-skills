...
description: "输入一句话，AI 帮你写词、作曲、编曲、演唱，一首完整的歌只要 0.65 元。支持人声克隆与专属歌手风格，让 AI 用你的音色唱；支持 AI 翻唱、续写、混音、采样、母带重制、伴奏分离与分轨导出。含 17 种生成操作、13 个接口的完整参数表与真实计费口径。需要自备 api.a7w.cn 的 API Key。遇到问题可加技术微信 9872659。"
version: 1.0.0
